...
for(const marker of ['gpt-5.6-luna','self_check_passed','uncertainty_reason','confidenceLabel','answerable'])if(!tutor.includes(marker))throw new Error(`Tutor sem proteção obrigatória: ${marker}.`);
