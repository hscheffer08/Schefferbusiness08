...
if(!premium.includes("export { default } from './education-tutor.js'"))throw new Error('A rota Premium precisa reutilizar o tutor principal para não perder as proteções de qualidade.');
