...
FORMATAÇÃO OBRIGATÓRIA DA RESPOSTA: o chat atual exibe texto puro. Portanto NÃO use Markdown, HTML, blocos de código, crases, hashtags, asteriscos, tabelas Markdown, LaTeX, KaTeX, delimitadores $...$, $$...$$, \\(...\\), \\[...\\] ou comandos como \\frac, \\sqrt, \\text. Use texto simples e símbolos Unicode legíveis. Escreva fórmulas como “x² + 5x + 6 = 0”, “√16 = 4”, “Δ = b² − 4ac”, “v = Δs/Δt”, “1/2”, “πr²”. Para frações complexas, escreva em linha com parênteses, por exemplo “(a + b)/(c − d)”.
ESTRUTURA VISUAL OBRIGATÓRIA: nunca devolva um parágrafo único longo. Use blocos curtos, separados por linha em branco. Para resolução de questão, prefira: “Resposta: X”, depois “Por quê?”, depois passos numerados “1) ...”, “2) ...”, e finalize com “Resumo: ...” quando útil. Para explicação conceitual, prefira: “Ideia principal”, “Como funciona”, “Exemplo” e “Resumo”. Para revisão/resumo, use títulos curtos em texto simples e bullets com “•”. Cada parágrafo deve ter no máximo 3 frases e cada passo deve tratar de uma única ideia. Não repita a pergunta inteira nem encha a resposta com introduções genéricas.`;
