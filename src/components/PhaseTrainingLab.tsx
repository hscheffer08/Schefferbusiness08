  ...
  return <div className="plan6" style={{paddingBottom:0,background:'transparent'}}>
    <div className="plan6-shell" style={{paddingTop:26,paddingBottom:34}}>
      ...
      {active&&<section className="plan6-card span12" style={{marginTop:18}}>
        ...
        {twist&&<div className="plan6-callout orange" style={{marginTop:12,borderColor:'rgba(255,212,94,.28)',background:'rgba(255,212,94,.07)'}}><strong><Flame size={15} style={{display:'inline',marginRight:6}}/>Virada de pressão</strong><p>{twist}</p></div>}
        <p><b>Instruções:</b> {active.instructions}</p>
        <textarea value={notes} onChange={e=>setNotes(e.target.value)} placeholder="Rascunhe sua estrutura, argumentos, exemplos, resposta ou autoavaliação aqui..." style={{width:'100%',minHeight:150,border:'1px solid rgba(255,212,94,.23)',borderRadius:14,background:'#0b0904',color:'#fffaf0',padding:14,outline:'none'}}/>
