...
export default function OfficialQuestionWorkspaceV3(){
  ...
  async function loadOfficial(q:OfficialRef){
    reset();setActiveOfficial(q);setActivePractice(null);setExtracting(true);const key=`conectae:official-v13:${q.question_id}`;
