...
import { BarChart3, BookOpenCheck, BrainCircuit, ChevronLeft, FileText, Home, LayoutGrid, Loader2, LockKeyhole, LogIn, LogOut, Mic2, ScanLine, Sparkles, Target, UserCheck } from 'lucide-react';
