...
import { BarChart3, ClipboardCheck, FileText, Loader2, LockKeyhole, LogIn, LogOut, ScanLine, Target, UserCheck } from 'lucide-react';
...
function Gate({ onBack }: { onBack: () => void }) {
  ...
  const navItems=[['curso-inicio','Meu plano',Target],['curso-metas','Metas',BarChart3],['correcao-simulado','Simulados',ClipboardCheck],['curso-visual','Questões visuais',ScanLine],['curso-redacao','Redação',FileText]] as const;
