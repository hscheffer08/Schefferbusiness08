...
export default function OfficialQuestionWorkspace(){
  ...
  return <section className="pb-8">
    ...
    {!filtered.length&&<div className="mt-4 rounded-2xl border border-[#173765] bg-[#06152f] p-5 text-sm text-[#9fb5d4]">{mode==='official'?'Nenhuma questão oficial completa disponível aqui ainda. Use Estilo da prova para treinar agora sem confundir itens autorais com questões oficiais.':'Nenhuma questão com esses filtros.'}</div>}
