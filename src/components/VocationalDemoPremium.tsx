    ...
    <div className="min-h-screen pb-16">
      <div className="max-w-7xl mx-auto px-5 md:px-8 pt-6">
        ...
        <section className="mb-10">
          ...
          <button onClick={() => setShowAll((value) => !value)} className="mt-5 w-full py-3 rounded-xl border border-ink-800 bg-ink-900 hover:border-ink-700 text-sm font-semibold text-ink-300 inline-flex items-center justify-center gap-2">{showAll ? <>Mostrar Top 7 <ChevronUp className="w-4 h-4" /></> : <>Ver os 50 cursos <ChevronDown className="w-4 h-4" /></>}</button>
        </section>
