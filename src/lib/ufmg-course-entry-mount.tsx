  ...
  return createPortal(
    <button type="button" onClick={openUFMGCourseArea} className="mb-5 flex w-full touch-manipulation items-center gap-4 rounded-[22px] border border-[#31588e] bg-[linear-gradient(135deg,#0b2856,#06152f)] p-4 text-left shadow-xl shadow-black/10 transition hover:border-[#72a5ff] md:mb-7 md:p-5">
      ...
      <span className="min-w-0 flex-1">
        ...
        <span className="mt-1 block text-xs leading-relaxed text-[#a9bddc]">1º, 2º e 3º anos separados • conteúdo oficial por componente • prova oficial UFMG 2025 + treino autoral.</span>
        <span className="mt-2 flex flex-wrap gap-x-4 gap-y-1 text-[10px] font-bold text-[#8fb2e3]"><span className="inline-flex items-center gap-1"><BookOpenCheck size={12}/>45 questões oficiais de 2025</span><span className="inline-flex items-center gap-1"><ListChecks size={12}/>78 autorais • 26 por etapa</span></span>
      </span>
