        ...
        <section className="grid lg:grid-cols-[1.02fr_.98fr] gap-10 lg:gap-14 items-center pt-8 md:pt-14 lg:pt-20">
          <div>
            ...
            <div className="grid sm:grid-cols-2 gap-4 max-w-3xl">
              <button className="group rounded-[26px] border border-cyan-300/25 bg-gradient-to-br from-cyan-400/15 via-brand-500/10 to-transparent p-6 text-left hover:-translate-y-1 transition-all"><div className="w-12 h-12 rounded-2xl bg-cyan-300 text-[#06131c] flex items-center justify-center mb-5"><Compass className="w-6 h-6" /></div><div className="text-[11px] font-black tracking-[.15em] text-cyan-200 uppercase mb-2">Ainda explorando</div><h2 className="text-2xl font-black mb-2">Fazer teste vocacional</h2><p className="text-sm text-ink-400 leading-relaxed mb-5">Entenda cursos que combinam com interesses, valores, habilidades e estilo de trabalho.</p><span className="inline-flex items-center gap-2 font-bold text-cyan-200">Descobrir meu caminho <ArrowRight className="w-4 h-4" /></span></button>
