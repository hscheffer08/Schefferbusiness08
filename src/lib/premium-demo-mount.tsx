...
export default function PremiumDemoMount(){
  ...
  const teaser=host?createPortal(<section className="relative overflow-hidden rounded-[30px] border border-amber-300/20 bg-gradient-to-r from-amber-300/[.08] via-white/[.03] to-[#ffd45e]/10 p-6 md:p-8"><div className="relative flex flex-col justify-between gap-6 lg:flex-row lg:items-center"><div className="max-w-3xl"><div className="mb-3 inline-flex items-center gap-2 rounded-full border border-amber-300/20 bg-amber-300/10 px-3 py-1.5 text-[11px] font-black uppercase tracking-[.14em] text-amber-100"><Crown className="h-3.5 w-3.5"/>Conectaê Premium</div><h2 className="text-2xl font-black md:text-3xl">IA sem limite diário + plano aprofundado por {PREMIUM_PRICE}/mês.</h2><p className="mt-2 text-sm leading-relaxed text-stone-400 md:text-base">Inclui simulados autorais Premium e correção avançada que transforma seus erros em prioridade no plano.</p></div><button onClick={()=>setOpen(true)} className="shrink-0 rounded-2xl bg-amber-300 px-5 py-3.5 font-black text-[#050505] transition hover:-translate-y-0.5">Conhecer Premium</button></div></section>,host):null;
