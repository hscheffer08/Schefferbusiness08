// Questions listed here are intentionally unavailable in the scored interactive bank.
// Older entries are incomplete in the structured source; 2024/2025 entries below
// were officially annulled and therefore must not be scored as ordinary questions.
